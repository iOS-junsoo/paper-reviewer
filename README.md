...
- **5개 섹션 분석** — 연구 배경 / 해결하려는 것 / 연구 방법론 / 실험·결과 / 수식 정리. 핵심 용어 볼드, 결정적 문장 형광펜, 인라인 `$수식$` KaTeX 렌더링. 제목 아래에 **핵심 기여 2~4줄** 요약
- **실험·결과 탭** — 데이터셋 · 비교 대상(baseline) · 핵심 지표(논문 결과 강조 카드) · ablation 통찰 · 한계와 향후 연구를 한 탭에 정리
