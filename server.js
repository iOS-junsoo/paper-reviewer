...
- method_steps: 4~8개 단계. ==단계 수는 논문의 실제 논리 단위를 따르세요(4~8은 범위일 뿐 6이 기준이 아님) — 방법이 단순하면 4, 복잡하면 8도 좋습니다==. 각 단계는 짧은 title + "무엇을 + 왜"를 담은 description + 일상 비유(analogy). 비유는 그 단계의 핵심 직관을 비전공자도 떠올릴 수 있게. 데이터가 흘러가는 순서대로 배열하세요.
