  ...
  "equations": [
    {
      ...
      "bbox": { "x0": 0.12, "y0": 0.34, "x1": 0.88, "y1": 0.40, "설명": "paper_page 위에서 이 수식이 차지하는 영역. 페이지 좌상단을 (0,0), 우하단을 (1,1)로 한 정규화 좌표(x=가로, y=세로). 수식 줄 전체를 살짝 여유있게 감싸도록. 위치를 모르면 bbox 자체를 생략" },
